...
class pennsieve_handler(Subject):
    """
    ...
    def workflow(self):
        ...
        print(f"Python support for targeted downloads, including time segment downloads, is available on request from the Data team.")
        print("This is due to certain permission issues. Pennsieve releases a full api, this code should be updated to call on the API properly and rescope variables to pennsieve equivalents.")
